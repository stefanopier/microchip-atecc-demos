...
#include <../src/third_party/wolfssl/wolfcrypt/random.h>
...
#ifdef HAVE_X963_KDF
    #include <../src/third_party/wolfssl/wolfcrypt/hash.h>
#endif
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/silabs/silabs_ecc.h>
#endif

#if defined(WOLFSSL_KCAPI_ECC)
    #include <../src/third_party/wolfssl/wolfcrypt/port/kcapi/kcapi_ecc.h>
#endif
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/sp_int.h>
#endif
