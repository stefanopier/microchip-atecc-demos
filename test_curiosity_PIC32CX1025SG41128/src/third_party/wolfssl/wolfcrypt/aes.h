...
WOLFSSL_LOCAL void GHASH(Gcm* gcm, const byte* a, word32 aSz, const byte* c,
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/fips.h>
...
#endif
#ifdef STM32_CRYPTO
    #include <../src/third_party/wolfssl/wolfcrypt/port/st/stm32.h>
#endif
...
#include <../src/third_party/wolfssl/wolfcrypt/port/xilinx/xil-versal-glue.h>
...
#include <../src/third_party/wolfssl/wolfcrypt/port/af_alg/wc_afalg.h>
#endif

#if defined(WOLFSSL_KCAPI_AES)
#include <../src/third_party/wolfssl/wolfcrypt/port/kcapi/wc_kcapi.h>
#endif
...
#include <../src/third_party/wolfssl/wolfcrypt/port/devcrypto/wc_devcrypto.h>
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/silabs/silabs_aes.h>
#endif
...
#include <psa/crypto.h>
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/arm/cryptoCell.h>
#endif

#if (defined(WOLFSSL_RENESAS_TSIP_TLS) && \
    defined(WOLFSSL_RENESAS_TSIP_TLS_AES_CRYPT)) ||\
    defined(WOLFSSL_RENESAS_TSIP_CRYPTONLY)
    #include <../src/third_party/wolfssl/wolfcrypt/port/Renesas/renesas_tsip_types.h>
#endif
