...
#include <../src/third_party/wolfssl/wolfcrypt/settings.h>
#include <../src/third_party/wolfssl/wolfcrypt/wc_port.h>
#include <../src/third_party/wolfssl/wolfcrypt/oid_sum.h>
...
#define WC_SAFE_SUM_WORD32(in1, in2, out) ((in2) <= 0xffffffffU - (in1) ? \
    ...
    WOLFSSL_API void XFREE(void *p, void* heap, int type);
        ...
        #include <../src/third_party/wolfssl/wolfcrypt/port/intel/quickassist_mem.h>
