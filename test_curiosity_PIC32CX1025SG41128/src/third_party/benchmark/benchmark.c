...
#endif
#include <../src/third_party/wolfssl/wolfcrypt/settings.h> /* also picks up user_settings.h */
...
#include <../src/third_party/wolfssl/wolfcrypt/wc_port.h>
#include <../src/third_party/wolfssl/wolfcrypt/wolfmath.h>
#include <../src/third_party/wolfssl/wolfcrypt/memory.h>
...
#ifdef HAVE_CHACHA
    #include <../src/third_party/wolfssl/wolfcrypt/chacha.h>
#endif
#ifdef HAVE_POLY1305
    #include <../src/third_party/wolfssl/wolfcrypt/poly1305.h>
#endif
#if defined(HAVE_CHACHA) && defined(HAVE_POLY1305)
    #include <../src/third_party/wolfssl/wolfcrypt/chacha20_poly1305.h>
#endif
#ifndef NO_AES
    #include <../src/third_party/wolfssl/wolfcrypt/aes.h>
#endif
#ifdef HAVE_CAMELLIA
    #include <../src/third_party/wolfssl/wolfcrypt/camellia.h>
#endif
#ifdef WOLFSSL_SM4
    #include <../src/third_party/wolfssl/wolfcrypt/sm4.h>
#endif
#ifndef NO_MD5
    #include <../src/third_party/wolfssl/wolfcrypt/md5.h>
#endif
#ifndef NO_SHA
...
#endif
#ifdef WOLFSSL_SM3
     #include <../src/third_party/wolfssl/wolfcrypt/sm3.h>
#endif
#ifndef NO_RSA
    #include <../src/third_party/wolfssl/wolfcrypt/rsa.h>
#endif
#ifdef WOLFSSL_RIPEMD
    #include <../src/third_party/wolfssl/wolfcrypt/ripemd.h>
#endif
#ifdef WOLFSSL_CMAC
...
#endif
#ifndef NO_RC4
    #include <../src/third_party/wolfssl/wolfcrypt/arc4.h>
#endif
#ifndef NO_HMAC
    #include <../src/third_party/wolfssl/wolfcrypt/hmac.h>
#endif
#ifdef WOLFSSL_SIPHASH
    #include <../src/third_party/wolfssl/wolfcrypt/siphash.h>
#endif
...
#endif
#ifdef WOLFSSL_SM2
    #include <../src/third_party/wolfssl/wolfcrypt/sm2.h>
#endif
#ifdef HAVE_CURVE25519
    #include <../src/third_party/wolfssl/wolfcrypt/curve25519.h>
#endif
#ifdef HAVE_ED25519
    #include <../src/third_party/wolfssl/wolfcrypt/ed25519.h>
#endif
#ifdef HAVE_CURVE448
    #include <../src/third_party/wolfssl/wolfcrypt/curve448.h>
#endif
#ifdef HAVE_ED448
    #include <../src/third_party/wolfssl/wolfcrypt/ed448.h>
#endif
#ifdef WOLFSSL_HAVE_MLKEM
    #include <../src/third_party/wolfssl/wolfcrypt/mlkem.h>
    #ifdef WOLFSSL_WC_MLKEM
        #include <../src/third_party/wolfssl/wolfcrypt/wc_mlkem.h>
    #endif
    #if defined(HAVE_LIBOQS)
        #include <../src/third_party/wolfssl/wolfcrypt/ext_mlkem.h>
    #endif
#endif
#if defined(WOLFSSL_HAVE_LMS) && !defined(WOLFSSL_LMS_VERIFY_ONLY)
    #include <../src/third_party/wolfssl/wolfcrypt/lms.h>
    #ifdef HAVE_LIBLMS
        #include <../src/third_party/wolfssl/wolfcrypt/ext_lms.h>
    #else
        #include <../src/third_party/wolfssl/wolfcrypt/wc_lms.h>
    #endif
#endif
#if defined(WOLFSSL_HAVE_XMSS) && !defined(WOLFSSL_XMSS_VERIFY_ONLY)
    #include <../src/third_party/wolfssl/wolfcrypt/xmss.h>
    #ifdef HAVE_LIBXMSS
        #include <../src/third_party/wolfssl/wolfcrypt/ext_xmss.h>
    #else
        #include <../src/third_party/wolfssl/wolfcrypt/wc_xmss.h>
    #endif
#endif
#ifdef WOLFCRYPT_HAVE_ECCSI
    #include <../src/third_party/wolfssl/wolfcrypt/eccsi.h>
#endif
#ifdef WOLFCRYPT_HAVE_SAKKE
    #include <../src/third_party/wolfssl/wolfcrypt/sakke.h>
#endif

#if defined(HAVE_FALCON)
    #include <../src/third_party/wolfssl/wolfcrypt/falcon.h>
#endif
#if defined(HAVE_DILITHIUM)
    #include <../src/third_party/wolfssl/wolfcrypt/dilithium.h>
#endif
#if defined(HAVE_SPHINCS)
    #include <../src/third_party/wolfssl/wolfcrypt/sphincs.h>
#endif

#ifdef WOLF_CRYPTO_CB
    #include <../src/third_party/wolfssl/wolfcrypt/cryptocb.h>
    #ifdef HAVE_INTEL_QA_SYNC
        #include <../src/third_party/wolfssl/wolfcrypt/port/intel/quickassist_sync.h>
    #endif
    #ifdef HAVE_CAVIUM_OCTEON_SYNC
        #include <../src/third_party/wolfssl/wolfcrypt/port/cavium/cavium_octeon_sync.h>
    #endif
    #ifdef HAVE_RENESAS_SYNC
        #include <../src/third_party/wolfssl/wolfcrypt/port/renesas/renesas_sync.h>
    #endif
    #if defined(WOLFSSL_MAX3266X) || defined(WOLFSSL_MAX3266X_OLD)
        #include <../src/third_party/wolfssl/wolfcrypt/port/maxim/max3266x-cryptocb.h>
    #endif
#endif

#ifdef WOLFSSL_ASYNC_CRYPT
    #include <../src/third_party/wolfssl/wolfcrypt/async.h>
#endif

#include <../src/third_party/wolfssl/wolfcrypt/cpuid.h>
...
#define MILLION_VALUE 1000000.0
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/Espressif/esp32-crypt.h>
...
#include <../src/third_party/wolfssl/wolfcrypt/mem_track.h>
...
#ifdef HAVE_ASCON
    #include <../src/third_party/wolfssl/wolfcrypt/ascon.h>
#endif
...
/* determine benchmark buffer to use (if NO_FILESYSTEM) */
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/blake2.h>
#endif
...
#ifdef WOLFSSL_CAAM
    #include <../src/third_party/wolfssl/wolfcrypt/port/caam/wolfcaam.h>
