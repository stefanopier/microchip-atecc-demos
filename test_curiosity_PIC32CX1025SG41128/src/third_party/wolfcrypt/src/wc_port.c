...
#include <../src/third_party/wolfssl/wolfcrypt/cpuid.h>
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/nxp/ksdk_port.h>
#endif

#if defined(WOLFSSL_MAX3266X) || defined(WOLFSSL_MAX3266X_OLD)
    #include <../src/third_party/wolfssl/wolfcrypt/port/maxim/max3266x.h>
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/cypress/psoc6_crypto.h>
#endif

#ifdef MAXQ10XX_MODULE_INIT
    #include <../src/third_party/wolfssl/wolfcrypt/port/maxim/maxq10xx.h>
#endif

#if defined(WOLFSSL_ATMEL) || defined(WOLFSSL_ATECC508A) || \
    defined(WOLFSSL_ATECC608A)
    #include <../src/third_party/wolfssl/wolfcrypt/port/atmel/atmel.h>
#endif
#if defined(WOLFSSL_RENESAS_TSIP)
    #include <../src/third_party/wolfssl/wolfcrypt/port/Renesas/renesas-tsip-crypt.h>
#endif
#if defined(WOLFSSL_RENESAS_FSPSM)
    #include <../src/third_party/wolfssl/wolfcrypt/port/Renesas/renesas-fspsm-crypt.h>
#endif
#if defined(WOLFSSL_RENESAS_RX64_HASH)
    #include <../src/third_party/wolfssl/wolfcrypt/port/Renesas/renesas-rx64-hw-crypt.h>
#endif
#if defined(WOLFSSL_STSAFEA100)
    #include <../src/third_party/wolfssl/wolfcrypt/port/st/stsafe.h>
#endif

#if defined(WOLFSSL_TROPIC01)
    #include <../src/third_party/wolfssl/wolfcrypt/port/tropicsquare/tropic01.h>
#endif
...
#include <../src/third_party/wolfssl/wolfcrypt/memory.h>
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/aria/aria-cryptocb.h>
#endif
#if defined(WOLFSSL_DEVCRYPTO)
    #include <../src/third_party/wolfssl/wolfcrypt/port/devcrypto/wc_devcrypto.h>
#endif
#ifdef WOLFSSL_IMXRT_DCP
    #include <../src/third_party/wolfssl/wolfcrypt/port/nxp/dcp_port.h>
#endif
...
#include <../src/third_party/wolfssl/wolfcrypt/port/nxp/se050_port.h>
#endif
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/port/psa/psa.h>
#endif

#if defined(HAVE_LIBOQS)
    #include <../src/third_party/wolfssl/wolfcrypt/port/liboqs/liboqs.h>
#endif
...
/* custom memory wrappers */
    ...
    #include <../src/third_party/wolfssl/wolfcrypt/src/port/ti/ti-ccm.c>  /* initialize and Mutex for TI Crypt Engine */
    #include <../src/third_party/wolfssl/wolfcrypt/src/port/ti/ti-hash.c> /* md5, sha1, sha224, sha256 */
#endif

#if defined(WOLFSSL_CRYPTOCELL)
    #define WOLFSSL_CRYPTOCELL_C
    #include <../src/third_party/wolfssl/wolfcrypt/src/port/arm/cryptoCell.c> /* CC310, RTC and RNG */
    #if !defined(NO_SHA256)
        #define WOLFSSL_CRYPTOCELL_HASH_C
        #include <../src/third_party/wolfssl/wolfcrypt/src/port/arm/cryptoCellHash.c> /* sha256 */
    #endif
#endif
