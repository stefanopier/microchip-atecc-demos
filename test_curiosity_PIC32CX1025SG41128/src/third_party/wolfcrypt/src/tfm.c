...
#include <../src/third_party/wolfssl/wolfcrypt/tfm.h>
#include <../src/third_party/wolfssl/wolfcrypt/src/asm.c>  /* will define asm MACROS or C ones */
#include <../src/third_party/wolfssl/wolfcrypt/wolfmath.h> /* common functions */
